...
class Background extends ParallaxComponent {
  ...
  Future<void> onLoad() async {
    final layers = [
      ...
      ParallaxImageData('scenery/bbbackground.png'),
      // ParallaxImageData('scenery/clouds.png'),
      // ParallaxImageData('scenery/cliffs.png'),
      ParallaxImageData('scenery/ttrees.png'),
      ParallaxImageData('scenery/vigan_city_bg_bg.png'),
      ParallaxImageData('scenery/vigan_city_bg.png'),
      ParallaxImageData('scenery/gggground.png'),
    ];
