...
<<<<<<< HEAD
=======
  late final double airLevel = (size.y / 5) - (size.y / 2);
>>>>>>> 935c058 (upload)
...
<<<<<<< HEAD
      ...
      addScore: addScore,
=======
      position: Vector2(-size.x / 6, groundLevel - 900),
      addScore: addScore,
...
=======
      SpawnComponent.periodRange(
        factory: (_) => Obstacle.random(
          random: _random,
          canSpawnLamp: level.canSpawnLamp,
        ),
        minPeriod: 3,
        maxPeriod: 5,
>>>>>>> 935c058 (upload)
...
<<<<<<< HEAD
=======
    if (level.canSpawnFlying) {
      add(
        SpawnComponent.periodRange(
          factory: (_) => FlyingObstacle(),
          minPeriod: 5.0,
          maxPeriod: 6.0 + level.number,
          area: Rectangle.fromPoints(
            Vector2(size.x / 2, airLevel),
            Vector2(size.x / 2, airLevel),
          ),
          random: _random,
        ),
